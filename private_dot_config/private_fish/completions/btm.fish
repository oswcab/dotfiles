complete -c btm -s C -l config -d 'Sets the location of the config file.' -r
...
complete -c btm -s t -l default_time_value -d 'Default time value for graphs in ms.' -r
...
complete -c btm -s r -l rate -d 'Sets a refresh rate in ms.' -r
complete -c btm -s d -l time_delta -d 'The amount in ms changed upon zooming.' -r
complete -c btm -l retention -d 'The timespan of data kept.' -r
...
complete -c btm -s n -l unnormalized_cpu -d 'Show process CPU% without normalizing over the number of cores.'
